...
class Api extends Base {
	...
	shopInfoUpdate(param, callback) {
		var allParams = {
			url: 'Common/ShopInfo/update',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	shopInfoGet(param, callback) {
		var allParams = {
			url: 'Common/ShopInfo/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	registerShop(param, callback) {
		var allParams = {
			url: 'Project/Register/registerShop',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	registerAgent(param, callback) {
		var allParams = {
			url: 'Project/Register/registerAgent',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
